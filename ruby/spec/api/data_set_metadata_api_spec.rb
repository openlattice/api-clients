...
# Unit tests for OpenapiClient::DataSetMetadataApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DataSetMetadataApi' do
  before do
  ...
  describe 'test an instance of DataSetMetadataApi' do
    it 'should create an instance of DataSetMetadataApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::DataSetMetadataApi)
    end
  end
