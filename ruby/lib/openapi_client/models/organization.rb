...
module OpenapiClient
  class Organization
    ...
    attr_accessor :sms_entity_set_info
    ...
    def self.openapi_types
      {
        ...
        :'roles' => :'Array<Role>',
        :'apps' => :'Array<String>',
        :'sms_entity_set_info' => :'Array<SmsEntitySetInformation>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'sms_entity_set_info')
        if (value = attributes[:'sms_entity_set_info']).is_a?(Array)
          self.sms_entity_set_info = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          roles == o.roles &&
          apps == o.apps &&
          sms_entity_set_info == o.sms_entity_set_info &&
    ...
    def hash
      [id, principal, title, description, emails, members, roles, apps, sms_entity_set_info, partitions].hash
    end
