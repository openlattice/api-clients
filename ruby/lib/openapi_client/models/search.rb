...
module OpenapiClient
  ...
  class Search
    ...
    attr_accessor :property_type_ids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Search` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Search`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'property_type_ids')
        if (value = attributes[:'property_type_ids']).is_a?(Array)
          self.property_type_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          property_type_ids == o.property_type_ids &&
          start == o.start &&
          max_hits == o.max_hits
    end
    ...
    def hash
      [keyword, entity_type_id, property_type_ids, start, max_hits].hash
    end
