...
module OpenapiClient
  class CollectionsApi
    ...
    # @return [nil]
    def add_type_to_entity_type_collection_template(entity_type_collection_id, entity_type_collection, opts = {})
      add_type_to_entity_type_collection_template_with_http_info(entity_type_collection_id, entity_type_collection, opts)
      nil
    end
    ...
    def add_type_to_entity_type_collection_template_with_http_info(entity_type_collection_id, entity_type_collection, opts = {})
      ...
      if @api_client.config.client_side_validation && entity_type_collection.nil?
        fail ArgumentError, "Missing the required parameter 'entity_type_collection' when calling CollectionsApi.add_type_to_entity_type_collection_template"
      end
      # resource path
    ...
    def get_entity_set_collections_of_type_with_http_info(entity_set_collection_id, opts = {})
      ...
      # resource path
      local_var_path = '/datastore/collections/entity/type/entity/set/{entitySetCollectionId}'.sub('{' + 'entitySetCollectionId' + '}', CGI.escape(entity_set_collection_id.to_s))
