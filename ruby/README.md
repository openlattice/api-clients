...
*OpenapiClient::PermissionsApi* | [**update_acls**](docs/PermissionsApi.md#update_acls) | **PATCH** /datastore/permissions/update | Adds, removes, or sets the ace for a particular set of acl keys. Successful only if user is the owner of all acl keys.
