...
*OpenapiClient::OrganizationsApi* | [**destroy_transported_entity_set**](docs/OrganizationsApi.md#destroy_transported_entity_set) | **GET** /datastore/organizations/{organizationId}/{entitySetId}/destroy | Marks entity set for transporter for materialized views
