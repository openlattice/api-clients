...
class EdmApi(object):
    ...
    def get_entity_data_model_version(self, **kwargs):  # noqa: E501
        """Returns the current entity data model version.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_data_model_version(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_entity_data_model_version_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_entity_data_model_version_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_entity_data_model_version_with_http_info(self, **kwargs):  # noqa: E501
        """Returns the current entity data model version.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_entity_data_model_version_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_entity_data_model_version" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def get_property_usage_summary_with_http_info(self, property_type_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PropertyUsageSummary',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_schemas_in_namespace(self, **kwargs):  # noqa: E501
        """Gets all schemas associated with a given namespace and accessible by the caller.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schemas_in_namespace(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_schemas_in_namespace_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_schemas_in_namespace_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_schemas_in_namespace_with_http_info(self, **kwargs):  # noqa: E501
        """Gets all schemas associated with a given namespace and accessible by the caller.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_schemas_in_namespace_with_http_info(async_req=True)
        >>> result = thread.get()
