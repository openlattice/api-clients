...
class PermissionsApi(object):
    ...
    def get_acl(self, acl_key, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_acl_with_http_info(acl_key, **kwargs)  # noqa: E501
        else:
            (data) = self.get_acl_with_http_info(acl_key, **kwargs)  # noqa: E501
            return data

    def get_acl_with_http_info(self, acl_key, **kwargs):  # noqa: E501
        """Get the ACL for the given ACL Key, only if the user is the owner of the ACL Key.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_acl_with_http_info(acl_key, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'acl_key' is set
        if ('acl_key' not in local_var_params or
                local_var_params['acl_key'] is None):
            raise ValueError("Missing the required parameter `acl_key` when calling `get_acl`")  # noqa: E501
