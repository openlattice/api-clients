...
conf = openlattice.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.openlattice.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("openlattice")
    ...
    def auth_settings(self):
        ...
        if 'openlattice_auth' in self.api_key:
            auth['openlattice_auth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
