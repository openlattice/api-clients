...
class MetadataUpdate(object):
    ...
    def __init__(self, title=None, description=None, name=None, contacts=None, type=None, pii=None, default_show=None, url=None, property_tags=None, index_type=None, organization_id=None, partitions=None, enum_values=None, local_vars_configuration=None):  # noqa: E501
