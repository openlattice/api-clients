...
class Organization(object):
    ...
    def __init__(self, id=None, principal=None, title=None, description=None, emails=None, members=None, roles=None, apps=None, sms_entity_set_info=None, partitions=None, local_vars_configuration=None):  # noqa: E501
