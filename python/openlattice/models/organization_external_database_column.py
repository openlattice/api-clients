...
class OrganizationExternalDatabaseColumn(object):
    ...
    def __init__(self, id=None, name=None, title=None, description=None, table_id=None, organization_id=None, data_type=None, primary_key=None, ordinal_position=None):  # noqa: E501
