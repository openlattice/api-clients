...
class EntitySetCollection(object):
    ...
    def __init__(self, id=None, name=None, title=None, description=None, entity_type_collection_id=None, template=None, contacts=None, organization_id=None):  # noqa: E501
    ...
    def name(self):
        ...
        he unique name of the entity set collection.  # noqa: E501
