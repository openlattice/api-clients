...
class NeighborEntityDetails(object):
    ...
    def __init__(self, association_entity_set=None, association_details=None, neighbor_entity_set=None, neighbor_id=None, neighbor_details=None, local_vars_configuration=None):  # noqa: E501
