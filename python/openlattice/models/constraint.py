...
class Constraint(object):
    ...
    def __init__(self, type=None, search_term=None, fuzzy=None, search_fields=None, property_type_id=None, latitude=None, longitude=None, radius=None, unit=None, zones=None, start=None, end=None):  # noqa: E501
