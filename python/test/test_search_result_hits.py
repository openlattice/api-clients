...
import openlattice
from openlattice.models.search_result_hits import SearchResultHits  # noqa: E501
from openlattice.rest import ApiException

class TestSearchResultHits(unittest.TestCase):
    """SearchResultHits unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SearchResultHits
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openlattice.models.search_result_hits.SearchResultHits()  # noqa: E501
        if include_optional :
