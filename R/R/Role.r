  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`organizationId`)) {
        RoleObject[['organizationId']] <- self$`organizationId`
      }
      if (!is.null(self$`principal`)) {
        RoleObject[['principal']] <- self$`principal`$toJSON()
      }
      if (!is.null(self$`title`)) {
        RoleObject[['title']] <- self$`title`
      }
      if (!is.null(self$`description`)) {
        RoleObject[['description']] <- self$`description`
      }
