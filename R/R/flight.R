  ...
  public = list(
    ...
    initialize = function(
      ...
      if (!is.null(`entityDefinitions`)) {
        stopifnot(is.vector(`entityDefinitions`))
      ...
      if (!is.null(`associationDefinitions`)) {
        stopifnot(is.vector(`associationDefinitions`))
    ...
    fromJSON = function(FlightJson) {
      ...
      if (!is.null(FlightObject$`entityDefinitions`)) {
        self$`entityDefinitions` <- ApiClient$new()$deserializeObj(FlightObject$`entityDefinitions`, "list(EntityDefinition)", loadNamespace("openlattice"))
      }
