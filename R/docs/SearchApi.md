...
# **execute_app_search**
> SearchResult execute_app_search(search.term)
...
var.search.term <- SearchTerm$new("searchTerm_example", 123, 123, "fuzzy_example") # SearchTerm | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search.term** | [**SearchTerm**](SearchTerm.md)|  | 
...
> SearchResult execute_app_type_search(search.term)
...
> SearchResult execute_association_type_search(search.term)
...
> SearchResult execute_entity_set_collection_search(search.term)
...
> SearchResult execute_entity_type_collection_search(search.term)
...
> SearchResult execute_entity_type_search(search.term)
...
> SearchResult execute_fqn_property_type_search(search.term)
...
> SearchResult execute_organization_search(search.term)
...
> SearchResult execute_property_type_search(search.term)
