...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.PropertyDefinition();
  });
  ...
  describe('PropertyDefinition', function() {
    it('should create an instance of PropertyDefinition', function() {
      ...
      //var instane = new OpenLatticeApi.PropertyDefinition();
      //expect(instance).to.be.a(OpenLatticeApi.PropertyDefinition);
    });
