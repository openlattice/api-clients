...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.AssociationType();
  });
  ...
  describe('AssociationType', function() {
    it('should create an instance of AssociationType', function() {
      ...
      //var instane = new OpenLatticeApi.AssociationType();
      //expect(instance).to.be.a(OpenLatticeApi.AssociationType);
    });
    ...
    it('should have the property bidirectional (base name: "bidirectional")', function() {
      // uncomment below and update the code to test the property bidirectional
      //var instane = new OpenLatticeApi.AssociationType();
      //expect(instance).to.be();
    });
