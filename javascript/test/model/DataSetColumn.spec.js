...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.DataSetColumn();
  });
  ...
  describe('DataSetColumn', function() {
    it('should create an instance of DataSetColumn', function() {
      // uncomment below and update the code to test DataSetColumn
      //var instane = new OpenLatticeApi.DataSetColumn();
      //expect(instance).to.be.a(OpenLatticeApi.DataSetColumn);
    });
