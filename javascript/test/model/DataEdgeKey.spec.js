...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.DataEdgeKey();
  });
  ...
  describe('DataEdgeKey', function() {
    it('should create an instance of DataEdgeKey', function() {
      // uncomment below and update the code to test DataEdgeKey
      //var instane = new OpenLatticeApi.DataEdgeKey();
      //expect(instance).to.be.a(OpenLatticeApi.DataEdgeKey);
    });
