...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.Ace();
  });
  ...
  describe('Ace', function() {
    it('should create an instance of Ace', function() {
      // uncomment below and update the code to test Ace
      //var instane = new OpenLatticeApi.Ace();
      //expect(instance).to.be.a(OpenLatticeApi.Ace);
    });
