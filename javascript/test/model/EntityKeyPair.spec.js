...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.EntityKeyPair();
  });
  ...
  describe('EntityKeyPair', function() {
    it('should create an instance of EntityKeyPair', function() {
      // uncomment below and update the code to test EntityKeyPair
      //var instane = new OpenLatticeApi.EntityKeyPair();
      //expect(instance).to.be.a(OpenLatticeApi.EntityKeyPair);
    });
