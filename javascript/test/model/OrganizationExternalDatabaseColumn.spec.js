...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.OrganizationExternalDatabaseColumn();
  });
  ...
  describe('OrganizationExternalDatabaseColumn', function() {
    it('should create an instance of OrganizationExternalDatabaseColumn', function() {
      // uncomment below and update the code to test OrganizationExternalDatabaseColumn
      //var instane = new OpenLatticeApi.OrganizationExternalDatabaseColumn();
      //expect(instance).to.be.a(OpenLatticeApi.OrganizationExternalDatabaseColumn);
    });
