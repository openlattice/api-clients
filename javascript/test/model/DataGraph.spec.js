...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.DataGraph();
  });
  ...
  describe('DataGraph', function() {
    it('should create an instance of DataGraph', function() {
      // uncomment below and update the code to test DataGraph
      //var instane = new OpenLatticeApi.DataGraph();
      //expect(instance).to.be.a(OpenLatticeApi.DataGraph);
    });
