...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.AdvancedSearch();
  });
  ...
  describe('AdvancedSearch', function() {
    it('should create an instance of AdvancedSearch', function() {
      // uncomment below and update the code to test AdvancedSearch
      //var instane = new OpenLatticeApi.AdvancedSearch();
      //expect(instance).to.be.a(OpenLatticeApi.AdvancedSearch);
    });
