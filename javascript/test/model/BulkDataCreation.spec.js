...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.BulkDataCreation();
  });
  ...
  describe('BulkDataCreation', function() {
    it('should create an instance of BulkDataCreation', function() {
      // uncomment below and update the code to test BulkDataCreation
      //var instane = new OpenLatticeApi.BulkDataCreation();
      //expect(instance).to.be.a(OpenLatticeApi.BulkDataCreation);
    });
