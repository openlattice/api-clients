...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLatticeApi.DataSetColumnMetadata();
  });
  ...
  describe('DataSetColumnMetadata', function() {
    it('should create an instance of DataSetColumnMetadata', function() {
      // uncomment below and update the code to test DataSetColumnMetadata
      //var instane = new OpenLatticeApi.DataSetColumnMetadata();
      //expect(instance).to.be.a(OpenLatticeApi.DataSetColumnMetadata);
    });
