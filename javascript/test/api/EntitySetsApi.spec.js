...
(function(root, factory) {
  ...
  describe('EntitySetsApi', function() {
    ...
    describe('repartitionEntitySet', function() {
      it('should call repartitionEntitySet successfully', function(done) {
        //uncomment below and update the code to test repartitionEntitySet
        //instance.repartitionEntitySet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
