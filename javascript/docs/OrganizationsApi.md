...
let apiInstance = new OpenLatticeApi.OrganizationsApi();
let organizationId = null; // String | 
apiInstance.getOrganizationIntegrationAccount(organizationId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.refreshDataChanges(organizationId, entitySetId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
