...
let apiInstance = new OpenLatticeApi.AppApi();
let app = new OpenLatticeApi.App(); // App | 
...
> String createAppRole(appId, appRole)
...
let apiInstance = new OpenLatticeApi.AppApi();
let appId = null; // String | 
let appRole = new OpenLatticeApi.AppRole(); // AppRole | 
apiInstance.createAppRole(appId, appRole, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.deleteRoleFromApp(appId, roleId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.getAppByName(name, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> [HistoricalAppConfig] getAvailableAppConfigsOld(appId)
...
let apiInstance = new OpenLatticeApi.AppApi();
let appId = null; // String | 
apiInstance.getAvailableAppConfigsOld(appId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
