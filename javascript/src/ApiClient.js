...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://api.openlattice.com
         */
        this.basePath = 'https://api.openlattice.com'.replace(/\/+$/, '');
        ...
        this.authentications = {
            'http_auth': {type: 'bearer'}, // JWT
            'openlattice_auth': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
        }
