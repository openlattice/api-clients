...
export default class ShuttleApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/IntegrationStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/IntegrationStatus}
     */
    pollIntegration(jobId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = IntegrationStatus;
      return this.apiClient.callApi(
